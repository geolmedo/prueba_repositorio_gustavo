Algoritmo juego_de_dados
	...
	Segun turno Hacer
		1:
			...
			Escribir "Primer dado: ", primer_dado, ". Segundo dado: ", segundo_dado,". El crupier acumuló: ",suma_segundo_turno;
		...
		2:
			...
			Escribir "Primer dado: ", primer_dado, ". Segundo dado: ", segundo_dado,". El crupier acumuló: ",suma_primer_turno;
			primer_dado<-Aleatorio(1,6);
			segundo_dado<-Aleatorio(1,6);
			suma_segundo_turno<-primer_dado+segundo_dado;
